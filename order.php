...
<body>
		...
		<form action="" method="post">
			...
			<table class="payment_table" style="border-top: 7px solid #4CAF50;">
				...
				<tr style="width: 100%">
					...
					<th style="width: 50%"><input type="radio" name="p_method" onclick="show2();" id="Online" required>Online</th>
				</tr>
				<tr style=" margin-bottom: 1%;">
					<td colspan="2" style="display: none; width: 197.5%;" id="bkash_details">
						<h4>Account Marchant Account: 01761189963</h4>
						<h4>Counter #: 1</h4>
	...
	<script>
		function show1(){
		  document.getElementById('Online_details').style.display ='none';
		  document.getElementById('kash_details').style.display ='block';
		}

		function show2(){
		  document.getElementById('kash_details').style.display = 'none';
		  document.getElementById('Online_details').style.display = 'block';
		}
